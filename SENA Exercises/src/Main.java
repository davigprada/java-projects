...
public class Main {
    public static void main(String[] args) {
        ...
        //MENÚ COMIDA RAPIDA
        MenuComidaRapida miMenu = new MenuComidaRapida();
        miMenu.realizarPedido();

        //SENSOR TEMPERATURA
        SensorTemp mSensor = new SensorTemp();
        mSensor.verificarTemperatura();
        ...
        //TIENDA VIRTUAL
        TiendaVirtual mtienda = new TiendaVirtual();
        mtienda.realizarCompras();
        ...
        //REGISTRO DE VENTAS
        RegistroVentas misVentas = new RegistroVentas();
        misVentas.registrarVentas();
    }
}